...
class Category_model extends CI_Model{
    ...
    public function record_same_category($data,$id){
        ...
        $this->db->where($data);
        $row=$this->db->get("movie_category");
    ...
    public function update_category($data,$id){
        ...
        $this->db->where("id",$id);
        $this->db->update("movie_category",$data);
    ...
    public function category_delete_it($id){
        ...
        $this->db->where("id",$id);
        if($this->db->delete("movie_category"))
        return true;
    }
...
// <Get>
  public function select_option($array){
    ...
    public function get_cinevelo_category_token_search($var_name=null){
...
// </Get>
    ...
    public function get_cinevelo_category_to_option($flip=null,$id){
