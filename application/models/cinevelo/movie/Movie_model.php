...
class Movie_model extends CI_Model{
    ...
    $data["movie_categories"]=$this->category_model->get_cinevelo_category_to_option(false,false);
...
// <OWN>
    ...
    $this->db->insert("movie_file",$data);
