...
// <purchase_order> 
    public function get_purchase_order_amount($query_search){
    ...
    public function get_purchase_order($start,$end,$query_search){
    ...
    $data["details_html"]=$this->article_model->get_details_by_id("purchase_order",$data["id"]);
    ...
    // mismo registro
    public function record_same_purchase_order($data,$id){
        $ac=false;
        ...
        $this->db->where($data);
        $row=$this->db->get("purchase_order");
    ...
    public function purchase_order_delete_it($id){
