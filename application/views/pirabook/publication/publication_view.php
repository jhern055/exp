...
<?php  echo form_close();?>
                    ...
                    <div class="dataTable_wrapper" id="div_table">
                            ...
                            <?php echo $this->load->view("pirabook/publication/ajax/table-publication-view",$records_array,true); ?>
                    </div>
...
//         type: "GET",
//         data:{ajax:1},
//         url: "<?php echo base_url().$this->uri->uri_string."/publication_ajax/".(!empty($this->session->userdata('record_start_row_publication'))?$this->session->userdata('record_start_row_publication'):0 ); ?>",
//         beforeSend:function(html){
//             console.log(html);
//         },
//         success: function(html) {
...
// paginacion de ajax 
$(document).on("click", "ul.pirabook_publication_publication_ajax > li > a", function() {
