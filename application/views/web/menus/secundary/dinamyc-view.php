<?php $sessioMode=$this->session->userdata("sessionMode_menuSecundary");?>
    ...
    buttons: {
        Si: function() {
			...
			$.ajax({
				    ...
				    url: url+"web/menus/secundary/menuSecundary_delete",
				    type: 'POST',
				    dataType: 'json',
				    data: {
				    	id:id
				    ...
				    success: function(response){
							...
							modal: true,
							    buttons: {
							        ...
							        if(response.status)
            						{window.location.href="<?php echo base_url().'web/menus/secundary/'; ?>";}
