...
<?php $attributes_form = array('class' => 'formclientSubsidiary'); ?>
<?php  echo form_open("formTab2",$attributes_form);?>
	                        ...
	                        <div class="form-group">
	                        	<div class="btn btn-primary btn-xs" id="submitclientSubsidiary"><?php echo $txt_boton; ?></div>
	                        	<?php if(!empty($id)): ?>
	                        	<div class="btn btn-danger btn-xs" id="delete_clientSubsidiary" data-client_subsidiary="<?php echo encode_id($id); ?>"><?php echo "Eliminar"; ?></div>
	                        	<?php endif; ?>
	                        </div>
<?php  echo form_close();?>
