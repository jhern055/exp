<?php $sessioMode=$this->session->userdata("sessionMode_category");?>
    ...
    buttons: {
        Si: function() {
			...
			$.ajax({
				    ...
				    url: url+"admin/stock/catalog/category/category_delete",
				    type: 'POST',
				    dataType: 'json',
				    data: {
				    	id:id
				    ...
				    success: function(response){
							...
							modal: true,
							    buttons: {
							    	...
							    	if(response.status)
            						{window.location.href="<?php echo base_url().'admin/stock/catalog/category/'; ?>";}
