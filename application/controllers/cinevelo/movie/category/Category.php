...
class Category extends CI_Controller {
	...
	$this->load->model("cinevelo/movie/category/category_model");
// ------------------------
    ...
    // $uri_string=(!empty($uri_string["uri_string"])? $uri_string["uri_string"]:$this->uri->uri_string );
		...
		// Peliculas <category>
		$this->uri_category="cinevelo/movie/category/";
		// ... </category>	
	...
	$module=(!empty($module)?$module:"cinevelo/movie/category/");
	$data["module"]=$module;	
...
// insertar o actualizar
	...
	// categoryView
		...
		// <category_category>
			...
			// $this->load->model("cinevelo/stock/catalog/category/category_model");
...
// <category> 
	...
	$this->pagination->initialize($this->config_pagination("cinevelo/movie/category/category_ajax",$this->category_model->get_category_amount($query_search),$page_amount) );
	...
	$data["module_data"]["module_data_method_do_it"]="cinevelo/movie/category/categoryView/";

    $data["modules_quick"]=$this->load->get_back_access($module);

	$html=$this->load->view("cinevelo/movie/category/ajax/table-category-view",$data,true);
	$data["html"]=$html;
	...
	if(!empty($_POST["ajax"]))
	return print_r(json_encode(array("status"=>1,"msg"=>"HtmlConExito","html"=>$this->load->view("cinevelo/movie/category/category_view",$data,true) ))) ;
	else
	return $this->load->template("cinevelo/movie/category/category_view",$data);
	...
	$array['data']["module_data_method_do_it"]="cinevelo/movie/category/categoryView/";
	...
	$data=$this->category_model->get_cinevelo_category_token_search($var_name);
	}
