...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:retenciones="http://www.sat.gob.mx/esquemas/retencionpago/1" xmlns:arrendamientoenfideicomiso="arrendamientoenfideicomiso" xmlns:dividendos="dividendos" xmlns:enajenaciondeacciones="enajenaciondeacciones" xmlns:fideicomisonoempresarial="fideicomisonoempresarial" xmlns:intereses="intereses" xmlns:intereseshipotecarios="intereseshipotecarios" xmlns:operacionesderivados="operacionesderivados" xmlns:pagosaextranjeros="pagosaextranjeros" xmlns:planesderetiro="planesderetiro" xmlns:premios="premios" xmlns:sectorfinanciero="sectorfinanciero">
