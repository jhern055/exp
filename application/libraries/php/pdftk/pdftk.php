...
class pdftk {
    ...
    //StartConfiguration
    protected $sBin =""; // code added, check CODEID "COAD08822"
    //End Configuration
    ...
    function __construct($aParams =array()) {
        ...
        $this->sBin=strtoupper(substr(PHP_OS,0,3))!=='WIN' ? '/usr/bin/pdftk' : '"C:\Program Files (x86)\PDFtk Server\bin\pdftk.exe"' ; // NOTE :: windows path should be quouted cuz spaces in it
     ...
     *
     * @param $bReturn Should data be returned as well 'echo ed'
